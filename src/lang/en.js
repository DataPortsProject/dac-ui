export default {
  ...
  agentList: {
    ...
    createAgentDialogTitle: 'Create template',
    ...
    addImageDialogAccessToken: 'Access token',
    addImageDialogRepositoryUrl: 'Repository url',
    addImageDialogProjectId: 'Project Id',
    addImageDialogNameImage: 'Select image',
    privateRepository: 'Private repository',
    connect: 'Connect',
    testAgent: 'Test On-demand Agent',
    forTestOnly:
      'This option will be used to test on-demand type agents. This type of agents will be invoked from the Semantic Interoperability Component',
    ...
    containerName_characteristics:
      'The name of the container must be in lower case. No spaces or special characters. It can contain numbers.',
    downloadingTemplate: 'Downloading template',
    imageImported: 'imageImported',
    noParameters: 'Parameters not needed. Only the name of the container'
  },
  datasourceList: {
    idTableColumn: 'Id',
  ...
  subscriptionList: {
    ...
    deletedSubscription: 'Subscription deleted successfully',
    subscriptionCreated: 'Subscription created successfully',
    deleteSubscriptionDialogTitle: 'Delete subscription'
  },
  common: {
    ...
    previous: 'Previous',
    create: 'Create',
    reviewMandatoryFields: 'Review the mandatory fields'
  },
  models: {
    search: 'Search'
  },
  wizard: {
    ...
    description_api_agentType:
      'Connector / Agent whose data source will be an API',
    description_local_txt_file_agentType:
      'Connector / Agent whose data source will be a local txt file',
    description_local_excel_file_agentType:
      'Connector / Agent whose data source will be a local excel file',
    description_mqtt_listener_agentType:
      'Connector / Agent whose data source will be a MQTT Broker',
    description_api_listener_agentType:
      'Connector / Agent whose data source will be an API',
    description_rabbitMQ_listener_agentType:
      'Connector / Agent whose data source will be RabbitMQ Broker',
    description_posmgt_agentType:
      'Agent for the integration of a Posidonia Management instance',
    description_posops_agentType:
      'Agent for the integration of a Posidonia Operations instance',
    description_pospcs_agentType:
      'Agent for the integration of a Posidonia PCS instance'
  },
  overview: {
